...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CREATE", "INSERT", "INTO", "TABLE", "VALUES", "SERIAL", "PRIMARY", "KEY", 
			"VARCHAR", "NOT", "NULL", "INTEGER", "DATE", "SELECT", "FROM", "INNER", 
			"JOIN", "WHERE", "LLA_IZQ", "LLA_DER", "PAR_IZQ", "PAR_DER", "COR_IZQ", 
			"COR_DER", "ASIGN", "SEMICOL", "COMA", "PUNTO", "COMILLA", "STRING", 
			"NUM", "ID", "ALIAS", "WS"
		};
	}
